...
public class Lab2_SeleniumIDE_use {
	...
	public void setUp(){
		 System.setProperty("webdriver.firefox.bin","E:\\firefox-47.0.1.win64.sdk\\firefox-sdk\\bin\\firefox.exe");
		  	System.setProperty("webdriver.firefox.marionette","E:\\—ßœ∞1\\»Ìº˛≤‚ ‘\\geckodriver-v0.9.0-win64\\geckodriver.exe");
	...
	@Test
	public void test() {
		List<String> dataList=CSVUtils.importCsv(new File("E:\\—ßœ∞1\\»Ìº˛≤‚ ‘\\inputgit.csv"));
